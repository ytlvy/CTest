/*
 * @Author: Y.t
 * @Date: 2021-06-01 09:45:24
 * @LastEditors: Y.t
 * @LastEditTime: 2021-06-01 09:59:20
 * @Description: 
 */
#include <iostream>
#include <random>
...
bool ClipPixelsCpp(ClipData* cd) {
    ...
    cd->m_NumClippedPixels = num_cliped_pixels;
    return true;
}
...
void ClipPixels(void) {
    ...
    cout << "  rc2:
    cout << "  rc3:
    cout << "  cd1.m_NumPixels1:
    cout << "  cd2.m_NumPixels2:
    cout << "  cd3.m_NumPixels3:
